...
const TopPurchaseCategories = () => {
  // Dummy data for purchasing categories
  const purchasingCategories = [
    { id: 1, name: 'Frames & Forks', volume: '$3.7M', volumeValue: 3.7 },
    { id: 2, name: 'Electric System', volume: '$2.9M', volumeValue: 2.9 },
    { id: 3, name: 'Transmission', volume: '$1.8M', volumeValue: 1.8 },
    { id: 4, name: 'Wheels', volume: '$1.7M', volumeValue: 1.7 },
    { id: 5, name: 'Direction', volume: '$0.8M', volumeValue: 0.8 },
    { id: 6, name: 'Saddles & Seat Posts', volume: '$0.3M', volumeValue: 0.3 },
    { id: 7, name: 'Brakes', volume: '$0.0M', volumeValue: 0.05 },
    { id: 8, name: 'Maintenance', volume: '$0.0M', volumeValue: 0.05 },
  ];
  ...
  const maxVolume = Math.max(...purchasingCategories.map(cat => cat.volumeValue));
  ...
  return (
    <div className="container mx-auto p-4 bg-white shadow-md rounded-lg">
      ...
      <div className="bg-gray-100 p-4 rounded-md mb-6">
        <h2 className="text-lg font-semibold text-gray-700 mb-2">YTD Dec-23 compared to YTD Dec-22</h2>
        <p className="text-gray-600">Which categories drive the most Purchasing Value? From which Item and Supplier are we buying those categories?</p>
      </div>
